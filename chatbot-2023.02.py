...
def answerQuestion():
    ...
    try:
        ...
        spoken_answer_url = asyncio.get_event_loop().run_until_complete(text2speech(answer))
...
getencyclopediaInfo = input("What info about the student do you want? ")
print(f"The value for your request is {encyclopedia[getencyclopediaInfo]}")
